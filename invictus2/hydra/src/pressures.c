...
{
    k_tid_t tid = k_thread_create(&pressures_thread_data, pressures_thread_stack,
                                  K_THREAD_STACK_SIZEOF(pressures_thread_stack),
                                  pressures_thread_entry,
                                  NULL, NULL, NULL,
                                  PRESSURES_THREAD_PRIORITY, 0, K_NO_WAIT);
