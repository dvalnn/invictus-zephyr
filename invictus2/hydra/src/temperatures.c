...
{
    k_tid_t tid = k_thread_create(&thermos_thread_data, thermos_thread_stack,
                                  K_THREAD_STACK_SIZEOF(thermos_thread_stack),
                                  thermos_thread_entry,
                                  NULL, NULL, NULL,
                                  THERMOS_THREAD_PRIORITY, 0, K_NO_WAIT);
